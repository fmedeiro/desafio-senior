	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		return httpSecurity.csrf(csrf -> csrf.disable())
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers(HttpMethod.PUT, "/bookings/cancel/{bookingId}").permitAll()
						.requestMatchers(HttpMethod.PUT, "/bookings/checking/{bookingId}").hasRole("USER_ATTENDANT")
						.requestMatchers(HttpMethod.PUT, "/bookings/checkout/{bookingId}").hasRole("USER_ATTENDANT")
